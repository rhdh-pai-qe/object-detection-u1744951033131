...
3) Access the `workbench` named `object-detection-u1744951033131-notebook`.
...
5) In the terminal, run `cd object-detection-u1744951033131` to navigate to your sample app's directory.
